...
func testIntegerObject(t *testing.T, obj object.Object, expected int64) bool {
	...
	if res.Value != expected {
		t.Errorf("integer eval wrong value, expected=%d, got=%d", expected, res.Value)
		return false
	}
...
func testBooleanObject(t *testing.T, obj object.Object, expected bool) bool {
	...
	if res.Value != expected {
		t.Errorf("boolean eval wrong value, expected=%t, got=%t", expected, res.Value)
		return false
	}
...
func TestStringLiteral(t *testing.T) {
	...
	if str.Value != "Hello World!" {
		t.Errorf("String != %q, got=%q", "Hello World!", str.Value)
	}
}
...
func TestArrayLiterals(t *testing.T) {
	...
	if len(result.Elements) != 3 {
		t.Fatalf("array elements size mismatch, expected=3, got=%d", len(result.Elements))
	}
...
func TestHashLiterals(t *testing.T) {
	...
	for expectedKey, expectedValue := range expected {
		...
		if !ok {
			t.Errorf("no pair for given key = %+v", expectedKey)
		}
